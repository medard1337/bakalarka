...
lognf_1 = [math.log10(x) for x in nf_1]
logsa_1 = [math.log10(x) for x in sa_1]
lognf_2 = [math.log10(x) for x in nf_2]
logeap_2 = [math.log10(x) for x in eap_2]
logsa_3 = [math.log10(x) for x in sa_3]
logeap_3 = [math.log10(x) for x in eap_3]
...
xs3,ys3 = points_for_lin_regression(logeap_3,logsa_3)
...
b_WK,sigmaf_WK = new_koeficient_b_Sigmaf(k1r,q1r)
...
b_MCK,sigmaf_MCK = new_koeficient_b_Sigmaf(k2r,q2r)

#koeficient b a sigmaf pre kticku CDK
b_CDK,sigmaf_CDK = new_koeficient_b_Sigmaf(k3,q2)

print('(WK) Koeficient b =', round(b_WK,3),'Koeficient Sigmaf = ',round(sigmaf_WK,3))
print('(MCK) Koeficient b =', round(b_MCK,3),'Koeficient Epsilonf =',round(sigmaf_MCK,3))
print('(CDK) Koeficient b =', round(b_CDK,3),'Koeficient Sigmaf =',round(sigmaf_CDK,3))
...
#3
x3_0 = np.array(logeap_3)
y3_0 = np.array(logsa_3)
